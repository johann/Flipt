...
//        self.navigationController?.navigationBar.topItem!.leftBarButtonItem = UIBarButtonItem(title: "Close", style: UIBarButtonItemStyle.Plain, target: self, action: "closeButtonPressed")
//        
//        self.navigationController?.navigationBar.topItem!.leftBarButtonItem!.tintColor = UIColor.blackColor()
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        self.navigationController?.navigationBar.topItem!.rightBarButtonItem = composeItem
